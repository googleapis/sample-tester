...
def new(convention_name: str,
               user_paths: Iterable[str] = None):
  """Returns a new registry based on the `convention_name` and `user_paths`.
  ...
  registry = Registry()
  registry.add(*convention.generate_environments([convention_name], user_paths))
  return registry
